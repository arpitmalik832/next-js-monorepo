...
type UseApiRequest = {
  makeGetCall: <T, D>(params: RequestConfigWithBody<T>) => Promise<D>,
  makePostCall: <T, D>(params: RequestConfigWithBody<T>) => Promise<D>,
  makePutCall: <T, D>(params: RequestConfigWithBody<T>) => Promise<D>,
  makeDeleteCall: <T, D>(params: RequestConfigWithBody<T>) => Promise<D>,
...
function useApiRequest(): UseApiRequest {
  ...
  function makeGetCall<T, D>(params: RequestConfigWithBody<T>): Promise<D> {
  ...
  function makeDeleteCall<T, D>(params: RequestConfigWithBody<T>): Promise<D> {
    const { url, axiosInstance, config } = params;
